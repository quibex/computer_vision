...
import os
from comp_vision.yolo.yolo1 import SaveVideoFile, getBagVideo
...
def processing(request, pk: int):
    ...
    if str(vidoe_mp4.bag_file).split(".")[-1] != "mp4":
        vidoe_mp4.rgb_video = getBagVideo(vidoe_mp4.bag_file, vidoe_mp4.user_id, "rgb")
        vidoe_mp4.depth_video = getBagVideo(vidoe_mp4.bag_file, vidoe_mp4.user_id, "depth")
